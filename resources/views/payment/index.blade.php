                ...
                <tbody>
                    @forelse ($payments as $payment)
                        <tr>
                            ...
                            <td> <a class="btn btn-warning btn-sm" href="{{ route('payment.download', $payment->id) }}">Download</a>
                                <a class="btn btn-info btn-sm" href="{{ route('payment.invoice', $payment->id) }}">View</a> </td>
                        </tr>
                    @empty
